...
if __name__ == '__main__':
    ...
    # print(testinfo.login_info('route'))
    # print(testinfo.stand_alone.values())
    # print(testinfo.stand_alone.keys())
    # print(testinfo.stand_alone)
    # print(testinfo.stand_alone['登录'].get('extractresult'))
